...
using System.Net;
    ...
    public static class FileInfoX
    {
        ...
        {
            String sConnectionString = string.Format("Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties=Excel 12.0;",
                file.FullName);
        ...
        public static DataTable ReadExcel(this FileInfo file, string worksheetName)
        {
            ...
            DataTable data = ds.Tables[worksheetName];
