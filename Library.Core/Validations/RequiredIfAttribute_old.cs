...
{
    // how to use: [RequiredIf("HasReceipt", true, ErrorMessage = "You must enter purchase date")]
    //http://mvcdiary.com/2013/02/28/conditional-required-validation-or-field-mandatory-depends-on-another-field-mvc-4/
    public class RequiredIfAttribute_old : ValidationAttribute //, IClientValidatable
    {
        ...
        public RequiredIfAttribute_old(string dependentProperty, object targetValue)
        {
