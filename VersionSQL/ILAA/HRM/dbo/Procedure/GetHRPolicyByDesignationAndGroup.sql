...
-- =============================================
CREATE PROCEDURE [dbo].[GetHRPolicyByDesignationAndGroup]
...
BEGIN
	...
	SELECT 
	 ...
	 -- ,lpg.PolicyGroupName
  FROM [dbo].[HRPolicy] hrp 
  inner join [dbo].[LookPolicy]  lp on lp.LookPolicyId=hrp.LookPolicyId
  -- inner join [dbo].LookPolicyGroup  lpg on lpg.[LookPolicyGroupId]=hrp.[GroupTypeId]
