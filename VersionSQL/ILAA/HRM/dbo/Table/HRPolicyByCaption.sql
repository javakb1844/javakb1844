...
CREATE TABLE [dbo].[HRPolicyByCaption](
	...
	[LookOrganizationId] [bigint] NOT NULL,
...
ALTER TABLE [dbo].[HRPolicyByCaption] ADD  CONSTRAINT [DF_HRPolicyByCaption_LookOrganizationId]  DEFAULT ((0)) FOR [LookOrganizationId]
